...
       & Desarrollo de IDE propietario. Desarrollo de aplicacaciones orientada a microservicios. 

Nivel experto en Javascript. Nivel experto en CSS (incluido todo lo relacionado a HTML5, CSS3, Media Queries y Responsive Design).Extensivo conocimiento en la creación de frameworks propios de UI. Autonomía para llevar desarrollos complejos. Integración de diferentes plataformas: Web y móvil. Analisis/Desarrollo de aplicaciones Java con experiencia en la creación de aplicaciones de grado empresarial, escalables y de alto rendimiento. Integración e intercomunicación entre aplicaciones Java (EE) - NodeJs
